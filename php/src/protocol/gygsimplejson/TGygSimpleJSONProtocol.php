...
require_once $GLOBALS['THRIFT_ROOT'].'/protocol/gygsimplejson/TGygSimpleJSONProtocolMapContext.php';
require_once $GLOBALS['THRIFT_ROOT'].'/protocol/gygsimplejson/TGygSimpleJSONProtocolCollectionMapKeyException.php';

class TGygSimpleJSONProtocol extends TProtocol
{
    const COMMA = ',';
    const COLON = ':';
    const LBRACE = '{';
     ...
     */
    protected function pushWriteContext(TGygSimpleJSONProtocolContext $c) {
    ...
    protected function assertContextIsNotMapKey($invalidKeyType) {
        if ($this->writeContext_->isMapKey()) {
            throw new TGygSimpleJSONProtocolCollectionMapKeyException(
    ...
    public function __construct($trans)
    {
        ...
        $this->writeContext_ = new TGygSimpleJSONProtocolContext();
    }
    ...
    public function writeMessageBegin($name, $type, $seqid)
    {
        ...
        $this->pushWriteContext(new TGygSimpleJSONProtocolListContext($this));
    ...
    public function writeStructBegin($name)
    {
        ...
        $this->pushWriteContext(new TGygSimpleJSONProtocolStructContext($this));
    }
    ...
    public function writeMapBegin($keyType, $valType, $size)
    {
        ...
        $this->writeContext_->write();
        $this->trans_->write(self::LBRACE);
        $this->pushWriteContext(new TGygSimpleJSONProtocolMapContext($this));
    }
